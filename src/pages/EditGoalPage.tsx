...
const EditGoalPage = () => {
  ...
  useEffect(() => {
    ...
    setTrackingUnit(existingGoal.tracking_unit);
    setTargetValue(existingGoal.target_value);
    setCustomDays(existingGoal.custom_days || [1, 2, 3, 4, 5]);
    
    // Update UI state based on existing data
    setIsCustomType(existingGoal.type === 'custom');
    setIsCustomFrequency(existingGoal.frequency === 'custom');
    
  }, [id, existingGoal, isAuthenticated, navigate]);
    ...
    <Layout>
      <div className="space-y-6 max-w-3xl mx-auto">
        <div className="flex items-center">
          ...
          <h1 className="text-2xl font-bold ml-4">Edit Goal</h1>
        </div>
